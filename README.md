...
- [Current 10-march plan — September 20](player-state/army-composition.md) — ten unique, all-positive-affinity trios computed using September 20 stars and unlocked habits; qualitative deployment priorities, **not measured win rates**. Not recalculated for the September 22 relic updates.
